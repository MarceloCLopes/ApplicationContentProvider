package com.mcl.applicationcontentprovider.database
...
import com.mcl.applicationcontentprovider.database.NotesDatabaseHelper.Companion.TABLE_NOTES
...
class NotesProvider : ContentProvider() {
    ...
    companion object{
        const val AUTHORITY = "com.mcl.applicationcontentprovider.provider"
        val BASE_URI = Uri.parse("content://$AUTHORITY")
        val URI_NOTES = Uri.withAppendedPath(BASE_URI, "notes")

        //content://com.mcl.applicationcontentprovider.provider/notes
